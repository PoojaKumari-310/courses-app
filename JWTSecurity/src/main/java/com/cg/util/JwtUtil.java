...
public class JwtUtil {
	 ...
	 private String secret = "poojakumaripkkpoojakumaripkkpoojakumaripkkpoojakumaripkkpoojakumaripkk";
	    ...
	    public Boolean validateToken(String token, UserDetails userDetails) { // userdetails is username or password
	        final String username = extractUsername(token);
	        return (username.equals(userDetails.getUsername()) && !isTokenExpired(token)); // expired means limit  next 10 hrs
	    }
	}
